 ...
 *
 * The geometry is fixed at 1200×150 and scales with the container; the
 * coordinates come straight from the design file, so move a node here only by
 * moving it there first. Both blue nodes are the fan-out from the ingest API:
